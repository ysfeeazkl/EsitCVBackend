...
namespace EsitCV.Business.Concrete
{
    ...
    {
        public WorkExperienceManager(EsitCVContext context, IMapper mapper) : base(mapper, context)
        {

        }

        public Task<IDataResult> AddAsync(WorkExperienceAddDto workExperienceAddDto)
        {
        ...
        public Task<IDataResult> UpdateAsync(WorkExperienceUpdateDto workExperienceUpdateDto)
        {
            throw new NotImplementedException();
        }
    }
