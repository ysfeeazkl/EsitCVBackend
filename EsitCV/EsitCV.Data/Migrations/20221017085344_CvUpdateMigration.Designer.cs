...
namespace EsitCV.Data.Migrations
{
    ...
    [Migration("20221017085344_CvUpdateMigration")]
    partial class CvUpdateMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EsitCV.Entities.Concrete.Disableds.Disability", b =>
                {
                    ...
                    b.Property<int>("PercentageOfObstacles")
                        .HasColumnType("int");

                    b.Property<int?>("UserDisabilityID")
                        .HasColumnType("int");

                    b.HasKey("ID");

                    b.HasIndex("UserDisabilityID");
            ...
            modelBuilder.Entity("EsitCV.Entities.Concrete.OperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            CreatedByUserId = 0,
                            CreatedDate = new DateTime(2022, 10, 17, 11, 53, 44, 365, DateTimeKind.Local).AddTicks(9927),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByUserId = 0,
                            Name = "Admin"
                        ...
                        new
                        {
                            ID = 2,
                            CreatedByUserId = 0,
                            CreatedDate = new DateTime(2022, 10, 17, 11, 53, 44, 365, DateTimeKind.Local).AddTicks(9929),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByUserId = 0,
                            Name = "User"
                        ...
                        new
                        {
                            ID = 3,
                            CreatedByUserId = 0,
                            CreatedDate = new DateTime(2022, 10, 17, 11, 53, 44, 365, DateTimeKind.Local).AddTicks(9930),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByUserId = 0,
                            Name = "Company"
            ...
            modelBuilder.Entity("EsitCV.Entities.Concrete.UserDisability", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserDisabilities", (string)null);
                });
            ...
            modelBuilder.Entity("EsitCV.Entities.Concrete.Disableds.Disability", b =>
                {
                    b.HasOne("EsitCV.Entities.Concrete.UserDisability", null)
                        .WithMany("Disabilities")
                        .HasForeignKey("UserDisabilityID");
                });
            ...
            modelBuilder.Entity("EsitCV.Entities.Concrete.UserDisability", b =>
                {
                    b.HasOne("EsitCV.Entities.Concrete.User", "User")
                        .WithOne("UserDisability")
                        .HasForeignKey("EsitCV.Entities.Concrete.UserDisability", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
